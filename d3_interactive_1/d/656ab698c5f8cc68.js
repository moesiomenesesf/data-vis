...
{ d3.select("#tooltip").remove()
            let node = d3.select("body")
                        ...
                        .attr("class", "hidden")
                        .append("p")
                        .html("<strong><span id='name'></span></strong><br>Taxa de desemprego: <span id='taxa'></span>%")
              return node
          }
);
  main.variable(observer("showTooltip")).define("showTooltip", ["d3","rateById","counties_names"], function(d3,rateById,counties_names){return(
function showTooltip(county_id, x, y){
  ...
  d3.select("#name")
  .text(counties_names.get(county_id))
...
d3.json("https://gist.githubusercontent.com/emanueles/ee2997bc6237f3dcab952ae8becaf6bf/raw/afdb12d4ef89bb239998b295c94d960e8d89c19e/us.json")
  ...
  main.variable(observer("counties_names")).define("counties_names", ["d3"], function(d3){return(
