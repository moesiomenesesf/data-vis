  ...
  main.variable(observer("map")).define("map", ["view","L","updateFilters"], function(view,L,updateFilters)
{
  ...
  main.variable(observer("visibleMarkers")).define("visibleMarkers", function(){return(
[]
)});
  main.variable(observer("updateFilters")).define("updateFilters", ["layerList","visibleMarkers","idDimension","dc"], function(layerList,visibleMarkers,idDimension,dc){return(
